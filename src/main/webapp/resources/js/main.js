...
var _angularUiNotification = __webpack_require__(6);

var _angularUiNotification2 = _interopRequireDefault(_angularUiNotification);

var _angularChosenLocalytics = __webpack_require__(8);
...
var _deporteController = __webpack_require__(11);

var _deporteController2 = _interopRequireDefault(_deporteController);

var _torneoController = __webpack_require__(12);

var _torneoController2 = _interopRequireDefault(_torneoController);

var _premioController = __webpack_require__(13);

var _premioController2 = _interopRequireDefault(_premioController);

var _equipoController = __webpack_require__(14);

var _equipoController2 = _interopRequireDefault(_equipoController);

var _eventoControllerAdmin = __webpack_require__(15);

var _eventoControllerAdmin2 = _interopRequireDefault(_eventoControllerAdmin);

var _eventoController = __webpack_require__(16);

var _eventoController2 = _interopRequireDefault(_eventoController);

var _apuestaController = __webpack_require__(17);

var _apuestaController2 = _interopRequireDefault(_apuestaController);

var _equipoService = __webpack_require__(18);

var _equipoService2 = _interopRequireDefault(_equipoService);

var _deporteService = __webpack_require__(19);

var _deporteService2 = _interopRequireDefault(_deporteService);

var _premioService = __webpack_require__(20);

var _premioService2 = _interopRequireDefault(_premioService);

var _torneoService = __webpack_require__(21);

var _torneoService2 = _interopRequireDefault(_torneoService);

var _eventoService = __webpack_require__(22);

var _eventoService2 = _interopRequireDefault(_eventoService);

var _apuestaService = __webpack_require__(23);

var _apuestaService2 = _interopRequireDefault(_apuestaService);
...
//Controllers admin
var app = exports.app = _angular2.default.module('app', ['ui.router', 'ui-notification', 'localytics.directives', _angularUiBootstrap2.default]);

(0, _routes2.default)(app);

(0, _urlHelper2.default)(app);

(0, _deporteController2.default)(app);
(0, _deporteService2.default)(app);

(0, _torneoController2.default)(app);
(0, _torneoService2.default)(app);

(0, _premioController2.default)(app);
(0, _premioService2.default)(app);

(0, _equipoController2.default)(app);
(0, _equipoService2.default)(app);

(0, _eventoControllerAdmin2.default)(app);
(0, _eventoController2.default)(app);
(0, _eventoService2.default)(app);

(0, _apuestaController2.default)(app);
(0, _apuestaService2.default)(app);
    ...
    this.$get = ["$timeout", "$http", "$compile", "$templateCache", "$rootScope", "$injector", "$sce", "$q", "$window", function ($timeout, $http, $compile, $templateCache, $rootScope, $injector, $sce, $q, $window) {
        ...
        var notify = function notify(args, t) {
            ...
            if (template) {
                ...
                $http.get(args.template, { cache: true }).then(function (response) {
...
exports.default = function (app) {
    ...
    app.service('UrlHelper', ['$rootScope', '$state', '$stateParams', function ($rootScope, $state, $stateParams) {
        ...
        this.go = function (state, params, forwardCurrentParams) {
            if (!forwardCurrentParams) $state.go(state, params, { reload: true });else {
...
exports.default = function (app) {
    app.controller('DeporteController', ['$scope', '$timeout', '$q', 'DeporteService', 'Notification', function ($scope, $timeout, $q, DeporteService, Notification) {
        ...
        this.cambiarEstado = function (deporte) {
            var estado = 'activo';

            if (deporte.estado == 'activo') estado = 'inactivo';

            deporte.estado = estado;

            var params = { deporte: deporte };

            DeporteService.modificar(params).then(function (d) {
        ...
        this.save = function () {
            var params = { deporte: self.deporte };

            DeporteService.saveDeporte(params).then(function (d) {
...
exports.default = function (app) {
    app.controller('TorneoController', ['$scope', '$timeout', '$q', 'TorneoService', 'Notification', function ($scope, $timeout, $q, TorneoService, Notification) {
        ...
        this.cambiarEstado = function (torneo) {
            var estado = 'activo';

            if (torneo.estado == 'activo') estado = 'inactivo';

            torneo.estado = estado;

            var params = { torneo: torneo };

            TorneoService.modificar(params).then(function (d) {
                Notification.success('Actualizado correctamente');
                getTorneos();
            }, function (errResponse) {
                Notification.error('Se produjo un error');
        ...
        this.save = function () {
            var params = { torneo: self.torneo };

            TorneoService.saveTorneo(params).then(function (d) {
                Notification.success('Guardado correctamente');
                getTorneos();
            }, function (errResponse) {
                Notification.error('Se produjo un error');
        ...
        function getTorneos() {
            TorneoService.getTorneos().then(function (d) {
                self.torneos = d.data;
            }, function (errResponse) {
                Notification.error('Se produjo un error al mostrar el listado');
                console.error('Error recuperando torneos');
...
exports.default = function (app) {
    app.controller('PremioController', ['$scope', '$timeout', '$q', 'PremioService', 'Notification', function ($scope, $timeout, $q, PremioService, Notification) {
        ...
        this.cambiarEstado = function (premio) {
            var estado = 'activo';

            if (premio.estado == 'activo') estado = 'inactivo';

            premio.estado = estado;

            var params = { premio: premio };

            PremioService.modificar(params).then(function (d) {
                Notification.success('Actualizado correctamente');
                getPremios();
            }, function (errResponse) {
                Notification.error('Se produjo un error');
        ...
        this.save = function () {
            var params = { premio: self.premio };

            PremioService.savePremio(params).then(function (d) {
                Notification.success('Guardado correctamente');
                getPremios();
            }, function (errResponse) {
                Notification.error('Se produjo un error');
        ...
        function getPremios() {
            PremioService.getPremios().then(function (d) {
                self.premios = d.data;
            }, function (errResponse) {
                Notification.error('Se produjo un error al mostrar el listado');
                console.error('Error recuperando premios');
...
exports.default = function (app) {
    app.controller('EquipoController', ['$scope', '$timeout', '$q', 'EquipoService', 'Notification', function ($scope, $timeout, $q, EquipoService, Notification) {
        ...
        this.cambiarEstado = function (equipo) {
            var estado = 'activo';

            if (equipo.estado == 'activo') estado = 'inactivo';

            equipo.estado = estado;

            var params = { equipo: equipo };

            EquipoService.modificar(params).then(function (d) {
                Notification.success('Actualizado correctamente');
                getEquipos();
            }, function (errResponse) {
                Notification.error('Se produjo un error');
        ...
        this.save = function () {
            var params = { equipo: self.equipo };

            EquipoService.saveEquipo(params).then(function (d) {
                Notification.success('Guardado correctamente');
                getEquipos();
            }, function (errResponse) {
                Notification.error('Se produjo un error');
        ...
        function getEquipos() {
            EquipoService.getEquipos().then(function (d) {
                self.equipos = d.data;
            }, function (errResponse) {
                Notification.error('Se produjo un error al mostrar el listado');
                console.error('Error recuperando equipos');
...
exports.default = function (app) {
    app.controller('EventoControllerAdmin', ['$scope', '$timeout', '$q', 'EventoService', 'Notification', function ($scope, $timeout, $q, EventoService, Notification) {
        ...
        this.cambiarEstado = function (premio) {
            ...
            EventoService.modificar(params).then(function (d) {
                Notification.success('Actualizado correctamente');
                getEventos();
            }, function (errResponse) {
                Notification.error('Se produjo un error');
        ...
        this.save = function () {
            ...
            EventoService.saveEvento(params).then(function (d) {
                Notification.success('Guardado correctamente');
                getEventos();
            }, function (errResponse) {
                Notification.error('Se produjo un error');
        ...
        function getEventos() {
            EventoService.getEventos().then(function (d) {
                self.premios = d.data;
            }, function (errResponse) {
                Notification.error('Se produjo un error al mostrar el listado');
                console.error('Error recuperando premios');
...
exports.default = function (app) {
    app.controller('EventoController', ['$scope', '$timeout', '$q', 'UrlHelper', 'EventoService', 'Notification', function ($scope, $timeout, $q, UrlHelper, EventoService, Notification) {

        var self = this;

        this.eventos;

        this.apostar = function (evento) {
...
exports.default = function (app) {
    app.controller('ApuestaController', ['$scope', '$timeout', '$q', '$stateParams', 'UrlHelper', 'ApuestaService', 'Notification', function ($scope, $timeout, $q, $stateParams, UrlHelper, ApuestaService, Notification) {
        ...
        function getApuesta() {
            ApuestaService.getById($stateParams.id).then(function (d) {
                self.apuesta = d.data;
...
var API_BASE_URL = BASE_URL + "/api/equipo";
...
var getUrl = window.location.origin;
var BASE_URL = getUrl; //getUrl.protocol + "//" + getUrl.host + "/" + getUrl.pathname.split('/')[1];
var API_BASE_URL = BASE_URL + "/api/premio";
...
var getUrl = window.location.origin;
var BASE_URL = getUrl; //getUrl.protocol + "//" + getUrl.host + "/" + getUrl.pathname.split('/')[1];
var API_BASE_URL = BASE_URL + "/api/torneo";
...
var getUrl = window.location.origin;
var BASE_URL = getUrl; //getUrl.protocol + "//" + getUrl.host + "/" + getUrl.pathname.split('/')[1];
var API_BASE_URL = BASE_URL + "/api/evento";
...
var getUrl = window.location.origin;
var BASE_URL = getUrl; //getUrl.protocol + "//" + getUrl.host + "/" + getUrl.pathname.split('/')[1];
var API_BASE_URL = BASE_URL + "/api/apuesta";
